...
//   const datesInRange = (dateArray) => {
//     const startDate = dates.length > 0 ? new Date(dates[0]?.startDate) : null;
//     const endDate = dates.length > 0 ? new Date(dates[0]?.endDate) : null;
...
//     if (isSuccess) {
//       setOpen(false);
//       // Set the success message and remove after a delay
//       setReservationSuccess(true);
//       setTimeout(() => {
//         setReservationSuccess(false);
//         navigate("/");
...
//           Reserve Now!
//         </button>
//          {reservationSuccess && ( // Display success message conditionally
//           <div className="success-message">Room successfully booked!</div>
//         )}
//       </div>
//     </div>
//   );
