import { faBed,faCalendarDays,  faContactBook, faHome, faHotel, faPerson } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <div className="header">
            ...
            <p className="headerDesc">
                Get rewarded for your travels -unlock instant of 10% or more with a free booking account
            </p>
            <button className="headerBtn">Sign in / Register</button>
            <div className="headerSearch">
                <div className="headerSearchItem">
                    <FontAwesomeIcon icon={faBed} className="headerIcon"/>
                    <input type="text" placeholder="Where are going?"className="headerSearchInput"onChange={(e)=>setDestination(e.target.value)}/>
                </div>
                <div className="headerSearchItem">
